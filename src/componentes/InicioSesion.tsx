...
import { Text, View, Image, StyleSheet,
     TextInput, TouchableOpacity,
         Dimensions, Alert, ScrollView, ActivityIndicator, ImageBackground } from 'react-native';
...
const DispositivoWidth = Dimensions.get('window').width
