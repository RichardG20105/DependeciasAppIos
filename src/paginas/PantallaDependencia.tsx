    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ 
                ...
                >
                    <View style={{ height: HEIGHT / 2.9, width: WIDTH}}>
                       {(Dependencia?.fotos.length != 0)
                        ...
                        <ScrollView style={{paddingBottom: WIDTH * 0.60}}>
                            ...
                            <Text style={{color: "black", marginTop: 15,lineHeight: 22, marginLeft: 15, marginRight: 15, textAlign: 'justify', marginBottom: HEIGHT * 0.05}}>
