...
const PantallaInicio = () => {
        ...
        return (
            <View style={{flexDirection: 'row', height: 50, marginBottom: 11}}>
                ...
                <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    >
                        <Text style={{ color: "#295074", fontFamily: "System", fontSize: 20, lineHeight: 26, fontWeight: 'bold' }}>LODES - ESPOCH</Text>
                    </View>
                </View>
    ...
    function  renderMainCategories(){
        ...
        return(
            <View style={{ padding: 14, paddingBottom: 4, top: height * 0.23}}>
                <Text style={{ color: "#295074", fontFamily: "System", fontSize: 17, lineHeight: 21, fontWeight: 'bold' }}> Categorías </Text>
        ...
        return(
            <SafeAreaView style={style.container}>
                ...
                >
                    ...
                    >
                        <Text style={{fontFamily: "System",fontSize: 18, lineHeight: 22, color: "#295074", fontWeight: 'bold'}}>Dependencias</Text>
                    </View>
                </View>
            </View>
    ...
    function rendermainCards(){
        ...
        return(
            <>
                ...
                contentContainerStyle={{ paddingVertical: 6,paddingBottom: height * 0.28}}
                style={{top: height * 0.23}}
            />
    ...
    function InicioScreen(){
        return(
            <SafeAreaView style={{backgroundColor: '#E6EEF9', width,height}}>
                    ...
                    <Text style={{ color: "#295074", fontFamily: "System", fontSize: 17, lineHeight: 26, paddingLeft:14, fontWeight: 'bold', top:height * 0.23}}> Recomendados </Text>
                    {rendermainCards()}
            </SafeAreaView>
        )
    }
